...
import { MailCheckIcon, MoreHorizontalIcon, Trash2Icon } from "lucide-react";
  ...
  return (
    <div>
      <div className="mb-4 flex items-center justify-between">
        {!isSignedIn ? (
          <>
            ...
            <Button onClick={newChat} disabled={!isSignedIn}>
              New Chat
            </Button>
          </>
        ) : (
      ...
      {conversations.map((chat) => (
        <div
          className={`${chat.id === currentConversationId ? "bg-gray-200 font-bold pl-5 flex items-center" : "pl-5 flex items-center"}`}
          key={chat.id}
